...
public class DriveServiceHelper {
    ...
    public Task<String> createFilePDF(String filepath)
    {
        return Tasks.call(mExecutor,()->{
            ...
            fileMetaData.setName("BioRegPDF");

            java.io.File file = new java.io.File(filepath);

            FileContent mediaCintent = new FileContent("application/pdf",file);
            File myFile = null;
            try {
                myFile = mDriveService.files().create(fileMetaData,mediaCintent).execute();
            ...
            if(myFile == null)
            {
                throw new IOException("Null result requesting file creation");
            }
            return  myFile.getId();
