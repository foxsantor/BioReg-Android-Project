...
public final class LabelFormatter extends View {
    ...
    public LabelFormatter(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LabelFormatter(Context context, AttributeSet attrs, int defStyleAttr) {
