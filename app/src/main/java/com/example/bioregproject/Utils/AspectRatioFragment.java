...
import com.example.bioregproject.ui.Traceability.ImageFlow.ImageFlowAddImage;
...
public class AspectRatioFragment extends DialogFragment {
    ...
    private static ImageFlowAddImage con;

    public static AspectRatioFragment newInstance(Set<AspectRatio> ratios,
                                                  AspectRatio currentRatio, ImageFlowAddImage context) {
        con = context;
