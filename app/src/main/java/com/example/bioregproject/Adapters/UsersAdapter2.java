...
public class UsersAdapter2 extends ListAdapter<Account,UsersAdapter2.AccountsHolder> {
    ...
    public UsersAdapter2(Context context,Activity activity) {
        super(DIFF_CALLBACK);
    ...
    public AccountsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.users_card2, parent, false);
