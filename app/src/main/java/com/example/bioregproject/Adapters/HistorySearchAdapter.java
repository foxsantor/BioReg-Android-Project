...
public class HistorySearchAdapter extends ListAdapter<History,HistorySearchAdapter.HistoryHolder> {
    ...
    public HistorySearchAdapter(Context context,Activity activity) {
        super(DIFF_CALLBACK);
