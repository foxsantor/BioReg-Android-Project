...
public class SpinnerActionAdapter extends ArrayAdapter<String> {

    public SpinnerActionAdapter(Context context, ArrayList<String> list)
    {
    ...
    private View initView(int postion,View convertion,ViewGroup parent){
        if(convertion == null){
            convertion= LayoutInflater.from(getContext()).inflate(R.layout.cat_spinner,parent,false);}
